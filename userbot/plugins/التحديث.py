...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = (
        f"**⌯︙قام مطورين السورس بتحديث داركثون**\n⌯︙**التـغييرات\n** {changelog}"
    )
...
async def upstream(event):
    ...
    event = await edit_or_reply(event, "**⌯︙يـتـم البـحـث عـن تـحديثـات سـورس داركثون انـتـظـر**")
    ...
    if changelog == "" and not force_update:
        await event.edit(
            "**⌯︙سورس داركثون محدث الى اخر اصدار **\n"
            f"**قـنـاة سـورس داركثون** : "@riothon"
        )
        return repo.__del__()
    if conf == "" and not force_update:
        ...
        return await event.respond(
            f"⌔ :  لتحديث سورس داركثون ارسل : `.تحديث الان` "
        )
    ...
    if conf == "الان":
        await event.edit("** ⌯︙جار تحـديـث سـورس داركثون انـتـظـر قـليـلا 🧑‍💻⚡🇮🇶**")
